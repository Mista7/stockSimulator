...
public void createGUI(){
  ...
  stockMoneySlider = new GSlider(this, 7, 128, 174, 51, 10.0);
  stockMoneySlider.setShowValue(true);
  stockMoneySlider.setShowLimits(true);
  stockMoneySlider.setLimits(0, 0, 50000);
  stockMoneySlider.setNbrTicks(11);
  stockMoneySlider.setStickToTicks(true);
  ...
  StockBuyLabel = new GLabel(this, 18, 76, 150, 43);
  StockBuyLabel.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  StockBuyLabel.setText("Select the amount of money to invest in selected stock");
  StockBuyLabel.setLocalColorScheme(GCScheme.RED_SCHEME);
  StockBuyLabel.setOpaque(false);
  buyStock = new GButton(this, 54, 182, 80, 30);
  ...
  sellStock = new GButton(this, 231, 183, 80, 30);
